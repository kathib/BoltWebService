...
namespace SyndicationServiceLibrary
{
    ...
    public class Feed1 : IFeed1
    {
        public SyndicationFeedFormatter CreateFeed()
        {
            ...
            // rss -> http://localhost:8732/Design_Time_Addresses/SyndicationServiceLibrary/Feed1/
            // atom -> http://localhost:8732/Design_Time_Addresses/SyndicationServiceLibrary/Feed1/?format=atom
